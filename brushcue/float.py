...
# hash: 75cb7408c5191ab76f1757d18dfd813a6c53d621ef6f895554e1bc0e642cab0c
...
class Float(Object):
    ...
    if TYPE_CHECKING:
        ...
        def __add__(self, other: Float | builtins.float | builtins.int) -> Float: ...
        def __radd__(self, other: Float | builtins.float | builtins.int) -> Float: ...
        def __sub__(self, other: Float | builtins.float | builtins.int) -> Float: ...
        def __rsub__(self, other: Float | builtins.float | builtins.int) -> Float: ...
        def __mul__(self, other: Float | builtins.float | builtins.int) -> Float: ...
        def __rmul__(self, other: Float | builtins.float | builtins.int) -> Float: ...
        def __truediv__(self, other: Float | builtins.float | builtins.int) -> Float: ...
        def __rtruediv__(self, other: Float | builtins.float | builtins.int) -> Float: ...
        def __gt__(self, other: Float | builtins.float | builtins.int) -> bool.Bool: ...
        def __ge__(self, other: Float | builtins.float | builtins.int) -> bool.Bool: ...
        def __lt__(self, other: Float | builtins.float | builtins.int) -> bool.Bool: ...
        def __le__(self, other: Float | builtins.float | builtins.int) -> bool.Bool: ...
